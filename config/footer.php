<footer id="stickyFoot">
    <div id="link_footer">
        <a href="../pages/accueil.php"><img id="logoblogfooter" src="../images/logoblogfooter.png"
                                            alt="logo bLogOut"></a>
    ...
    <div id="menu_footer1">
        ...
        <?php
        if (!empty($_SESSION['user']) && $_SESSION['user']->getIdRight() == 1): ?>
            <li class="nav-item">
        ...
        <?php
        elseif (!empty($_SESSION['user']) && $_SESSION['user']->getIdRight() == 42): ?>
        <li class="nav-item">
            <a class="nav-link2" href="../pages/profil.php">Profil</a>
        </li>
        <li class="nav-item">
    ...
    <div id="menu_footer">
        <?php
        elseif (!empty($_SESSION['user']) && $_SESSION['user']->getIdRight() == 1337): ?>
            <li class="nav-item">
                <a class="nav-link2" href="../pages/profil.php">Profil</a>
            </li>
            <li class="nav-item">
