...
session_start();
$articlesTable = new \app\views\Article();
$showComment = new \app\views\Comment();
$com = new \app\controllers\Comment();
  ...
  <section id="showArticle">
    ...
    <div id="formCommentColumn">
      <?php if (isset($_SESSION['user'])) : ?>
        ...
        <form id="article" action="article.php?id=<?= $_GET['id']; ?><?php if (isset($_GET['modifcom'])) : echo " method="POST">
          <div>
