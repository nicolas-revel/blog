...
<main>
    <section id="info_articles">
        <h2 id="title_blogout2"><span class="bw">A</span><span
                    class="bw">r</span><span class="bw">t</span><span
                    class="bw">i</span><span class="bw">c</span><span
                    class="bw">l</span><span class="bw">e</span></h2>
    ...
    <section id="showArticle">
        ...
        <div id="formCommentColumn">
            ...
            <h6 id="titleCommentForm">BALANCE<br><span
                        id="letterCom">TON COMM'</span></h6>
                <form id="article"
                      action="article.php?id=<?= $_GET['id']; ?><?php if (isset
