...
<main>
    <section id="pageInscription">
        ...
        if (isset($_SESSION['user']) && !empty($_SESSION['user']->getId())) : ?>
            ...
            <div id="formProfil">
                <h3 id="title_ins"><span class="bw">M</span><span class="bw">o</span><span class="bw">m</span> <span
                            class="bw">c</span><span class="bw">o</span><span class="bw">m</span><span
                            class="bw">p</span><span class="bw">t</span><span class="bw">e</span></h3>
                ...
                <form id="blogForm" action="profil.php" method="POST">
                    ...
                    <br>
                    <p>Votre prénom actuel : <?= $currentUser->getFirstname() ?></p>
                    <div>
                        <label for="email">Nouveau prénom</label><br>
                        <input type="mail" name="email" required placeholder="E-mail">
                    </div>
                    <br>
                    <p>Votre nom actuel : <?= $currentUser->getLastname() ?></p>
                    <div>
                        <label for="email">Nouvel nom</label><br>
                        <input type="mail" name="email" required placeholder="E-mail">
                    </div>
                    <br>
                    <div>
