...
<main>
    ...
    <section id="present_blog">
        ...
        <div id="elementColumn">
            <h2 id="title_blogout"><span class="bw">H</span><span
                        class="bw">e</span><span class="bw">l</span><span
                        class="bw">l</span><span class="bw">o</span> <span
                        class="bw">W</span><span class="bw">o</span><span
                        class="bw">r</span><span class="bw">l</span><span
    ...
    <section id="info_user">
        ...
        <h6 id="login_user">BIENVENUE <?php if (!empty($_SESSION['user'])):
                ?><?= $currentUser->getLogin(); ?><?php endif; ?>!</h6>
        <div id="link_user">
            <?php if (!empty($_SESSION['user']) && $_SESSION['user']->getDroits()
                == 1): ?>
                <a href="../pages/profil.php">
                    <button id="button_user" type="button"
                            class="btn btn-outline-light">PROFIL
                    </button>
                </a>
                <a href="../pages/articles.php">
                    <button id="button_user" type="button"
                            class="btn btn-outline-light">VOIR ARTICLES
                    </button>
                </a>
            <?php elseif (!empty($_SESSION['user']) &&
                $_SESSION['user']->getDroits() == 1337): ?>
                <a href="../pages/creer_article.php">
                    <button id="button_user" type="button"
                            class="btn btn-outline-light">ECRIRE UN ARTICLE
                    </button>
                </a>
                <a href="../pages/articles.php">
                    <button id="button_user" type="button"
                ...
                <a href="../pages/admin.php">
                    <button id="button_user" type="button"
                            class="btn btn-outline-light">ADMIN
                    </button>
                </a>
            <?php elseif (!empty($_SESSION['user']) &&
            ...
            <?php else: ?>
                <a href="../pages/inscription.php">
                    <button id="button_user" type="button"
                            class="btn btn-outline-light">INSCRIPTION
                    </button>
                </a>
                <a href="../pages/connexion.php">
                    <button id="button_user" type="button"
                            class="btn btn-outline-light">CONNEXION
                    </button>
                </a>
            <?php endif; ?>
        </div>
    ...
    <article id="LastArticle">
        ...
        <p id="text_lastArticle">Les trois derniers articles mis en ligne, vous
            pouvez retrouvez l'intégralité des articles<a class="buttonCard"
                                                          href="articles.php"
